...
public class Range {
    ...
    /**
     * Проверяет, находится ли переданное число в границах текущего.
     *
     * @param value число, предположительно находящееся в границах текущего.
     * @return true, если число входит в ряд, иначе - false.
     */
